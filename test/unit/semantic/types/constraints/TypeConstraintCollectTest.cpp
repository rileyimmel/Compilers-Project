...
TEST_CASE("TypeConstraintVisitor: if ", "[TypeConstraintVisitor]") {
  ...
  std::vector<std::string> expected{
      ...
      "\u27E6(x>0)@4:12\u27E7 = bool",                // binexpr is bool (changed from int because of SIP)
      ...
      "\u27E6x@3:12\u27E7 = \u27E6(x+1)@5:14\u27E7", // sides of assignment have
                                                     // same type
      "\u27E6(x>0)@4:12\u27E7 = bool",                // if condition is bool (changed from int because of SIP)
...
TEST_CASE("TypeConstraintVisitor: while ", "[TypeConstraintVisitor]") {
  ...
  std::vector<std::string> expected{
      ...
      "\u27E6(x>0)@4:15\u27E7 = bool",                // binexpr is bool (changed from int because of SIP)
      "\u27E6x@3:12\u27E7 = int",                    // operand is int
      ...
      "\u27E6x@3:12\u27E7 = \u27E6(x-1)@5:14\u27E7", // sides of assignment have
                                                     // same type
      "\u27E6(x>0)@4:15\u27E7 = bool",                // while condition is bool (changed from int because of SIP)
      "\u27E6foo@2:6\u27E7 = () -> \u27E6x@3:12\u27E7" // function type
  };
